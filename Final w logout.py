...
from tkinter import PhotoImage, LEFT, messagebox  # Added messagebox import
...
class RideApp:
    def __init__(self, master):
        ...
        # Log-out Button
        self.out_button = tk.Button(master, text="LOG OUT", font=("Candara", 20, "bold"), height=2, width=20, fg="#FFFFFF", bg="#000000", command=self.logout)  # Added command parameter
