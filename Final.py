...
class RideApp:
    ...
    def show_vehicle_details(self, vehicle_type):
        ...
        book_button.place(relx=0.5, rely=0.87, anchor="center", relwidth=0.6)

        close_button = tk.Button(popup, text="CANCEL", font=("Helvetica", 11), command=popup.destroy)
        close_button.place(relx=0.5, rely=0.93, anchor="center", relwidth=0.6)
